...
"border-radius:10px;")
        ...
        self.titile_bar = QFrame(self.window)
        self.titile_bar.setObjectName(u"titile_bar")
        self.titile_bar.setEnabled(True)
        self.titile_bar.setMinimumSize(QSize(0, 40))
        self.titile_bar.setMaximumSize(QSize(16777215, 50))
        self.titile_bar.setStyleSheet(u"background-color: none;")
        self.titile_bar.setFrameShape(QFrame.StyledPanel)
        self.titile_bar.setFrameShadow(QFrame.Raised)
        self.horizontalLayout = QHBoxLayout(self.titile_bar)
        self.horizontalLayout.setSpacing(0)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 5, 0, 0)
        self.frame_title = QFrame(self.titile_bar)
        ...
        self.frame_btns = QFrame(self.titile_bar)
...
"}")
        ...
        self.listaVentas.setGeometry(QRect(30, 70, 231, 411))
        font4 = QFont()
        font4.setFamily(u"Levenim MT")
        font4.setPointSize(12)
        self.listaVentas.setFont(font4)
        self.listaVentas.setFocusPolicy(Qt.StrongFocus)
        self.listaVentas.setStyleSheet(u"background-color: qlineargradient(spread:pad, x1:0.522682, y1:1, x2:0.516682, y2:0.011, stop:0 rgba(0, 111, 166, 255), stop:1 rgba(0, 170, 255, 255));")
        ...
        self.btn_agregar.setGeometry(QRect(310, 240, 121, 41))
...
"}")
        ...
        self.btn_borrar.setGeometry(QRect(310, 320, 121, 41))
...
"}")
        ...
        self.label_dia.setGeometry(QRect(300, 440, 121, 41))
        self.label_dia.setFont(font1)
        self.label_dia.setStyleSheet(u"color: rgb(0, 170, 255);")
        self.list_total = QListView(self.page_ventas)
        self.list_total.setObjectName(u"list_total")
        self.list_total.setGeometry(QRect(440, 440, 121, 41))
        self.list_total.setStyleSheet(u"background-color: qlineargradient(spread:pad, x1:0.522682, y1:1, x2:0.516682, y2:0.011, stop:0 rgba(0, 111, 166, 255), stop:1 rgba(0, 170, 255, 255));")
...
"}")
        ...
        self.label_status.setGeometry(QRect(300, 380, 261, 41))
...
"color: rgb(0, 170, 255);")
        ...
        self.textEdit = QTextEdit(self.page_config)
        self.textEdit.setObjectName(u"textEdit")
        self.textEdit.setGeometry(QRect(150, 20, 291, 41))
        self.label_4 = QLabel(self.page_config)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(50, 90, 391, 151))
        font6 = QFont()
        ...
        self.tableWidget = QTableWidget(self.page_historial)
        self.tableWidget.setObjectName(u"tableWidget")
        self.tableWidget.setGeometry(QRect(340, 70, 231, 211))
        ...
        self.calendarWidget.setGeometry(QRect(30, 30, 256, 183))
        self.label = QLabel(self.page_historial)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(350, 30, 151, 31))
        self.label.setFont(font1)
        self.label.setStyleSheet(u"color: rgb(0, 170, 255);")
        self.label_2 = QLabel(self.page_historial)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(350, 290, 151, 31))
        self.label_2.setFont(font1)
        self.label_2.setStyleSheet(u"color: rgb(0, 170, 255);")
        self.tableWidget_2 = QTableWidget(self.page_historial)
        self.tableWidget_2.setObjectName(u"tableWidget_2")
        self.tableWidget_2.setGeometry(QRect(340, 330, 231, 151))
        ...
        self.listaDeudas.setGeometry(QRect(340, 130, 231, 191))
        self.label_nuevacuenta = QLabel(self.page_cuentas)
        self.label_nuevacuenta.setObjectName(u"label_nuevacuenta")
        self.label_nuevacuenta.setGeometry(QRect(40, 340, 151, 31))
        ...
        self.buscarcuenta_entry = QTextEdit(self.page_cuentas)
        self.buscarcuenta_entry.setObjectName(u"buscarcuenta_entry")
        self.buscarcuenta_entry.setGeometry(QRect(30, 70, 171, 41))
        self.buscarcuenta_entry.viewport().setProperty("cursor", QCursor(Qt.IBeamCursor))
...
"}")
        ...
        self.agregardeuda_entry = QTextEdit(self.page_cuentas)
        self.agregardeuda_entry.setObjectName(u"agregardeuda_entry")
        self.agregardeuda_entry.setGeometry(QRect(340, 70, 171, 41))
        self.agregardeuda_entry.viewport().setProperty("cursor", QCursor(Qt.IBeamCursor))
        self.btn_agregardeuda = QPushButton(self.page_cuentas)
        self.btn_agregardeuda.setObjectName(u"btn_agregardeuda")
        self.btn_agregardeuda.setGeometry(QRect(530, 70, 41, 41))
...
"	color: rgb(255, 255, 255);\n"
"}")
        self.nuevacuenta_entry = QTextEdit(self.page_cuentas)
        self.nuevacuenta_entry.setObjectName(u"nuevacuenta_entry")
        self.nuevacuenta_entry.setGeometry(QRect(30, 380, 171, 41))
        self.nuevacuenta_entry.viewport().setProperty("cursor", QCursor(Qt.IBeamCursor))
        self.label_pago = QLabel(self.page_cuentas)
        self.label_pago.setObjectName(u"label_pago")
        self.label_pago.setGeometry(QRect(350, 340, 141, 31))
        self.label_pago.setFont(font1)
        self.label_pago.setStyleSheet(u"color: rgb(0, 170, 255);")
        self.pago_entry = QTextEdit(self.page_cuentas)
        self.pago_entry.setObjectName(u"pago_entry")
        self.pago_entry.setGeometry(QRect(340, 380, 171, 41))
        self.pago_entry.viewport().setProperty("cursor", QCursor(Qt.IBeamCursor))
        self.btn_nuevacuenta = QPushButton(self.page_cuentas)
        self.btn_nuevacuenta.setObjectName(u"btn_nuevacuenta")
        self.btn_nuevacuenta.setGeometry(QRect(220, 380, 41, 41))
...
"	color: rgb(255, 255, 255);\n"
"}")
        self.btn_pago = QPushButton(self.page_cuentas)
        self.btn_pago.setObjectName(u"btn_pago")
        self.btn_pago.setGeometry(QRect(530, 380, 41, 41))
        self.btn_pago.setFont(font3)
        self.btn_pago.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_pago.setStyleSheet(u"QPushButton {\n"
"	background-color: qlineargradient(spread:pad, x1:0.517, y1:1, x2:0.511, 				y2:0, stop:0 rgba(0, 69, 104, 255), stop:1 rgba(0, 170, 255, 255));\n"
"	color: rgb(0, 0, 0);\n"
"}\n"
"\n"
...
"}")
        ...
        self.btn_borrarcuenta.setGeometry(QRect(30, 440, 231, 41))
...
"}")
        ...
        self.btn_pagocompleto.setGeometry(QRect(340, 440, 231, 41))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_pago.setText(QCoreApplication.translate("MainWindow", u"Ok", None))
